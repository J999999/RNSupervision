 ...
 *      申请问责
 */
class ApplyDutyAdd  extends React.Component {
    ...
    uploadInfo=(files)=> {
        ...
        let requestData = { cause:this.reason,"fileList":files.join(','),projectId:id,recordType:3,sources:this.source,interviewUser:this.object,mainSituation:this.content};
        ...
        return (
            ...
            <KeyboardAwareScrollView style = {styles.all}>
                ...
                <View style={styles.edit}>
                    ...
                    <TextInputMultWidget  title='问责对象：'  placeholder='请输入' onChangeText={(text)=>{
                        this.object = text;
                    }}/>
