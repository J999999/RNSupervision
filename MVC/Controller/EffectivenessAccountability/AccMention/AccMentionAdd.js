...
export default class AccMentionAdd extends React.Component{
    ...
    render(): React.ReactNode {
        ...
        return (
            <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
                <TextInputWidget    title='来源:'  placeholder='请输入来源' onChangeText={(text)=>{
                    this.setState({sourceStr: text});
                }}/>
                <TextInputWidget    title='事由:'  placeholder='请输入事由' onChangeText={(text)=>{
