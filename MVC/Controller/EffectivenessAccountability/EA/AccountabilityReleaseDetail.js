...
export default class AccountabilityReleaseDetail extends React.Component {
    ...
    render(): React.ReactNode {
        ...
        return (
            <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
                ...
                <TextInputWidget editable={this.state.enabledEdit} value={this.state.interviewName} title='问责对象:'/>
                <TextInputMultWidget editable={this.state.enabledEdit} value={this.state.matter} title='问责事项:'/>
                <TextInputMultWidget editable={this.state.enabledEdit} value={this.state.situation} title='问责内容:'/>
