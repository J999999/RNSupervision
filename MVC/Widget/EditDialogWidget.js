...
export default class EditDialogWidget extends Component {
    constructor(props) {
        super(props);
            ...
            <Animated.View style={[styles.container, {opacity: this.state.opacityAnimationValue}]}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text style={{fontSize: 16, color: 'black',marginTop:20}}>{titleTxt}</Text>
                             <View style={[styles.center, {width: '90%',height:'90%'}]}>
                                <TextInput
                                    multiline = {true}
                                    numberOfLines = {6}
                                    style={{fontSize: 16, color: '#999',width:'100%',height:'90%',padding:0}}
